CREATE OR REPLACE FUNCTION public.sec_search(search text DEFAULT NULL::text, filing_date_lt date DEFAULT NULL::date, filing_date_gt date DEFAULT NULL::date, description_includes text DEFAULT NULL::text, description_excludes text DEFAULT NULL::text, company_name_includes text DEFAULT NULL::text, company_name_excludes text DEFAULT NULL::text)
