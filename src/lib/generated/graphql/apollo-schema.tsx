...
export type Mutation_Root = {
  ...
  /** delete data from the table: "sec_contract_type" */
  delete_sec_contract_type?: Maybe<Sec_Contract_Type_Mutation_Response>;
  /** delete single row from the table: "sec_contract_type" */
  delete_sec_contract_type_by_pk?: Maybe<Sec_Contract_Type>;
  ...
  /** insert data into the table: "sec_contract_type" */
  insert_sec_contract_type?: Maybe<Sec_Contract_Type_Mutation_Response>;
  /** insert a single row into the table: "sec_contract_type" */
  insert_sec_contract_type_one?: Maybe<Sec_Contract_Type>;
  ...
  /** update data of the table: "sec_contract_type" */
  update_sec_contract_type?: Maybe<Sec_Contract_Type_Mutation_Response>;
  /** update single row of the table: "sec_contract_type" */
  update_sec_contract_type_by_pk?: Maybe<Sec_Contract_Type>;
...
/** mutation root */
export type Mutation_RootDelete_Sec_Contract_TypeArgs = {
  where: Sec_Contract_Type_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Sec_Contract_Type_By_PkArgs = {
  id: Scalars['Int'];
};
...
/** mutation root */
export type Mutation_RootInsert_Sec_Contract_TypeArgs = {
  objects: Array<Sec_Contract_Type_Insert_Input>;
  on_conflict?: InputMaybe<Sec_Contract_Type_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Sec_Contract_Type_OneArgs = {
  object: Sec_Contract_Type_Insert_Input;
  on_conflict?: InputMaybe<Sec_Contract_Type_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Sec_Contract_TypeArgs = {
  _inc?: InputMaybe<Sec_Contract_Type_Inc_Input>;
  _set?: InputMaybe<Sec_Contract_Type_Set_Input>;
  where: Sec_Contract_Type_Bool_Exp;
};


/** mutation root */
export type Mutation_RootUpdate_Sec_Contract_Type_By_PkArgs = {
  _inc?: InputMaybe<Sec_Contract_Type_Inc_Input>;
  _set?: InputMaybe<Sec_Contract_Type_Set_Input>;
  pk_columns: Sec_Contract_Type_Pk_Columns_Input;
};
...
export type Query_Root = {
  ...
  /** fetch data from the table: "sec_contract_type" */
  sec_contract_type: Array<Sec_Contract_Type>;
  /** fetch aggregated fields from the table: "sec_contract_type" */
  sec_contract_type_aggregate: Sec_Contract_Type_Aggregate;
  /** fetch data from the table: "sec_contract_type" using primary key columns */
  sec_contract_type_by_pk?: Maybe<Sec_Contract_Type>;
...
export type Query_RootSec_Contract_TypeArgs = {
  distinct_on?: InputMaybe<Array<Sec_Contract_Type_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Sec_Contract_Type_Order_By>>;
  where?: InputMaybe<Sec_Contract_Type_Bool_Exp>;
};


export type Query_RootSec_Contract_Type_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Sec_Contract_Type_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Sec_Contract_Type_Order_By>>;
...
export type Query_RootSec_Contract_Type_By_PkArgs = {
  id: Scalars['Int'];
};
...
export type Sec_Contract = {
  ...
  contract_type_id?: Maybe<Scalars['Int']>;
...
export type Sec_Contract_Avg_Fields = {
  ...
  contract_type_id?: Maybe<Scalars['Float']>;
...
export type Sec_Contract_Bool_Exp = {
  ...
  contract_type_id?: InputMaybe<Int_Comparison_Exp>;
...
export type Sec_Contract_Order_By = {
  ...
  contract_type_id?: InputMaybe<Order_By>;
...
/** columns and relationships of "sec_contract_type" */
export type Sec_Contract_Type = {
  __typename?: 'sec_contract_type';
  id: Scalars['Int'];
  name: Scalars['String'];
  parent_id?: Maybe<Scalars['Int']>;
  /** An object relationship */
  parent_type?: Maybe<Sec_Contract_Type>;
  /** An array relationship */
  sub_types: Array<Sec_Contract_Type>;
  /** An aggregate relationship */
  sub_types_aggregate: Sec_Contract_Type_Aggregate;
};


/** columns and relationships of "sec_contract_type" */
export type Sec_Contract_TypeSub_TypesArgs = {
  distinct_on?: InputMaybe<Array<Sec_Contract_Type_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Sec_Contract_Type_Order_By>>;
...
/** columns and relationships of "sec_contract_type" */
export type Sec_Contract_TypeSub_Types_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Sec_Contract_Type_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Sec_Contract_Type_Order_By>>;
...
/** aggregated selection of "sec_contract_type" */
export type Sec_Contract_Type_Aggregate = {
  __typename?: 'sec_contract_type_aggregate';
  aggregate?: Maybe<Sec_Contract_Type_Aggregate_Fields>;
  nodes: Array<Sec_Contract_Type>;
};

/** aggregate fields of "sec_contract_type" */
export type Sec_Contract_Type_Aggregate_Fields = {
  __typename?: 'sec_contract_type_aggregate_fields';
  avg?: Maybe<Sec_Contract_Type_Avg_Fields>;
  count: Scalars['Int'];
  max?: Maybe<Sec_Contract_Type_Max_Fields>;
  min?: Maybe<Sec_Contract_Type_Min_Fields>;
  stddev?: Maybe<Sec_Contract_Type_Stddev_Fields>;
  stddev_pop?: Maybe<Sec_Contract_Type_Stddev_Pop_Fields>;
  stddev_samp?: Maybe<Sec_Contract_Type_Stddev_Samp_Fields>;
  sum?: Maybe<Sec_Contract_Type_Sum_Fields>;
  var_pop?: Maybe<Sec_Contract_Type_Var_Pop_Fields>;
  var_samp?: Maybe<Sec_Contract_Type_Var_Samp_Fields>;
  variance?: Maybe<Sec_Contract_Type_Variance_Fields>;
};


/** aggregate fields of "sec_contract_type" */
export type Sec_Contract_Type_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Sec_Contract_Type_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
};

/** order by aggregate values of table "sec_contract_type" */
export type Sec_Contract_Type_Aggregate_Order_By = {
  avg?: InputMaybe<Sec_Contract_Type_Avg_Order_By>;
  count?: InputMaybe<Order_By>;
  max?: InputMaybe<Sec_Contract_Type_Max_Order_By>;
  min?: InputMaybe<Sec_Contract_Type_Min_Order_By>;
  stddev?: InputMaybe<Sec_Contract_Type_Stddev_Order_By>;
  stddev_pop?: InputMaybe<Sec_Contract_Type_Stddev_Pop_Order_By>;
  stddev_samp?: InputMaybe<Sec_Contract_Type_Stddev_Samp_Order_By>;
  sum?: InputMaybe<Sec_Contract_Type_Sum_Order_By>;
  var_pop?: InputMaybe<Sec_Contract_Type_Var_Pop_Order_By>;
  var_samp?: InputMaybe<Sec_Contract_Type_Var_Samp_Order_By>;
  variance?: InputMaybe<Sec_Contract_Type_Variance_Order_By>;
};

/** input type for inserting array relation for remote table "sec_contract_type" */
export type Sec_Contract_Type_Arr_Rel_Insert_Input = {
  data: Array<Sec_Contract_Type_Insert_Input>;
  /** on conflict condition */
  on_conflict?: InputMaybe<Sec_Contract_Type_On_Conflict>;
};

/** aggregate avg on columns */
export type Sec_Contract_Type_Avg_Fields = {
  __typename?: 'sec_contract_type_avg_fields';
  id?: Maybe<Scalars['Float']>;
  parent_id?: Maybe<Scalars['Float']>;
};

/** order by avg() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Avg_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** Boolean expression to filter rows from the table "sec_contract_type". All fields are combined with a logical 'AND'. */
export type Sec_Contract_Type_Bool_Exp = {
  _and?: InputMaybe<Array<Sec_Contract_Type_Bool_Exp>>;
  _not?: InputMaybe<Sec_Contract_Type_Bool_Exp>;
  _or?: InputMaybe<Array<Sec_Contract_Type_Bool_Exp>>;
  id?: InputMaybe<Int_Comparison_Exp>;
  name?: InputMaybe<String_Comparison_Exp>;
  parent_id?: InputMaybe<Int_Comparison_Exp>;
  parent_type?: InputMaybe<Sec_Contract_Type_Bool_Exp>;
  sub_types?: InputMaybe<Sec_Contract_Type_Bool_Exp>;
};

/** unique or primary key constraints on table "sec_contract_type" */
export enum Sec_Contract_Type_Constraint {
  /** unique or primary key constraint */
  SecContractTypePkey = 'sec_contract_type_pkey'
}

/** input type for incrementing numeric columns in table "sec_contract_type" */
export type Sec_Contract_Type_Inc_Input = {
  id?: InputMaybe<Scalars['Int']>;
  parent_id?: InputMaybe<Scalars['Int']>;
};

/** input type for inserting data into table "sec_contract_type" */
export type Sec_Contract_Type_Insert_Input = {
  id?: InputMaybe<Scalars['Int']>;
  name?: InputMaybe<Scalars['String']>;
  parent_id?: InputMaybe<Scalars['Int']>;
  parent_type?: InputMaybe<Sec_Contract_Type_Obj_Rel_Insert_Input>;
  sub_types?: InputMaybe<Sec_Contract_Type_Arr_Rel_Insert_Input>;
};

/** aggregate max on columns */
export type Sec_Contract_Type_Max_Fields = {
  __typename?: 'sec_contract_type_max_fields';
  id?: Maybe<Scalars['Int']>;
  name?: Maybe<Scalars['String']>;
  parent_id?: Maybe<Scalars['Int']>;
};

/** order by max() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Max_Order_By = {
  id?: InputMaybe<Order_By>;
  name?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};
...
/** aggregate min on columns */
export type Sec_Contract_Type_Min_Fields = {
  __typename?: 'sec_contract_type_min_fields';
  id?: Maybe<Scalars['Int']>;
  name?: Maybe<Scalars['String']>;
  parent_id?: Maybe<Scalars['Int']>;
};

/** order by min() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Min_Order_By = {
  id?: InputMaybe<Order_By>;
  name?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** response of any mutation on the table "sec_contract_type" */
export type Sec_Contract_Type_Mutation_Response = {
  __typename?: 'sec_contract_type_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Sec_Contract_Type>;
};

/** input type for inserting object relation for remote table "sec_contract_type" */
export type Sec_Contract_Type_Obj_Rel_Insert_Input = {
  data: Sec_Contract_Type_Insert_Input;
  /** on conflict condition */
  on_conflict?: InputMaybe<Sec_Contract_Type_On_Conflict>;
};

/** on conflict condition type for table "sec_contract_type" */
export type Sec_Contract_Type_On_Conflict = {
  constraint: Sec_Contract_Type_Constraint;
  update_columns?: Array<Sec_Contract_Type_Update_Column>;
  where?: InputMaybe<Sec_Contract_Type_Bool_Exp>;
};

/** Ordering options when selecting data from "sec_contract_type". */
export type Sec_Contract_Type_Order_By = {
  id?: InputMaybe<Order_By>;
  name?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
  parent_type?: InputMaybe<Sec_Contract_Type_Order_By>;
  sub_types_aggregate?: InputMaybe<Sec_Contract_Type_Aggregate_Order_By>;
};

/** primary key columns input for table: sec_contract_type */
export type Sec_Contract_Type_Pk_Columns_Input = {
  id: Scalars['Int'];
};

/** select columns of table "sec_contract_type" */
export enum Sec_Contract_Type_Select_Column {
  /** column name */
  Id = 'id',
  /** column name */
  Name = 'name',
...
/** input type for updating data in table "sec_contract_type" */
export type Sec_Contract_Type_Set_Input = {
  id?: InputMaybe<Scalars['Int']>;
  name?: InputMaybe<Scalars['String']>;
  parent_id?: InputMaybe<Scalars['Int']>;
};
...
/** aggregate stddev on columns */
export type Sec_Contract_Type_Stddev_Fields = {
  __typename?: 'sec_contract_type_stddev_fields';
  id?: Maybe<Scalars['Float']>;
  parent_id?: Maybe<Scalars['Float']>;
};

/** order by stddev() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Stddev_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** aggregate stddev_pop on columns */
export type Sec_Contract_Type_Stddev_Pop_Fields = {
  __typename?: 'sec_contract_type_stddev_pop_fields';
  id?: Maybe<Scalars['Float']>;
  parent_id?: Maybe<Scalars['Float']>;
};

/** order by stddev_pop() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Stddev_Pop_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** aggregate stddev_samp on columns */
export type Sec_Contract_Type_Stddev_Samp_Fields = {
  __typename?: 'sec_contract_type_stddev_samp_fields';
  id?: Maybe<Scalars['Float']>;
  parent_id?: Maybe<Scalars['Float']>;
};

/** order by stddev_samp() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Stddev_Samp_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** aggregate sum on columns */
export type Sec_Contract_Type_Sum_Fields = {
  __typename?: 'sec_contract_type_sum_fields';
  id?: Maybe<Scalars['Int']>;
  parent_id?: Maybe<Scalars['Int']>;
};

/** order by sum() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Sum_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** update columns of table "sec_contract_type" */
export enum Sec_Contract_Type_Update_Column {
  /** column name */
  Id = 'id',
  /** column name */
  Name = 'name',
...
/** aggregate var_pop on columns */
export type Sec_Contract_Type_Var_Pop_Fields = {
  __typename?: 'sec_contract_type_var_pop_fields';
  id?: Maybe<Scalars['Float']>;
  parent_id?: Maybe<Scalars['Float']>;
};

/** order by var_pop() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Var_Pop_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** aggregate var_samp on columns */
export type Sec_Contract_Type_Var_Samp_Fields = {
  __typename?: 'sec_contract_type_var_samp_fields';
  id?: Maybe<Scalars['Float']>;
  parent_id?: Maybe<Scalars['Float']>;
};

/** order by var_samp() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Var_Samp_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};

/** aggregate variance on columns */
export type Sec_Contract_Type_Variance_Fields = {
  __typename?: 'sec_contract_type_variance_fields';
  id?: Maybe<Scalars['Float']>;
  parent_id?: Maybe<Scalars['Float']>;
};

/** order by variance() on columns of table "sec_contract_type" */
export type Sec_Contract_Type_Variance_Order_By = {
  id?: InputMaybe<Order_By>;
  parent_id?: InputMaybe<Order_By>;
};
...
export type Sec_Filing_Attachment = {
  ...
  sec_company: Sec_Company;
  /** An object relationship */
  sec_contract_type?: Maybe<Sec_Contract_Type>;
  /** An object relationship */
...
export type Sec_Filing_Attachment_Bool_Exp = {
  ...
  sec_contract_type?: InputMaybe<Sec_Contract_Type_Bool_Exp>;
...
export type Sec_Filing_Attachment_Inc_Input = {
  contract_type_id?: InputMaybe<Scalars['Int']>;
...
export type Sec_Filing_Attachment_Insert_Input = {
  ...
  sec_contract_type?: InputMaybe<Sec_Contract_Type_Obj_Rel_Insert_Input>;
...
export type Sec_Filing_Attachment_Order_By = {
  ...
  sec_contract_type?: InputMaybe<Sec_Contract_Type_Order_By>;
...
export type Sec_Search_Args = {
  ...
  contract_type_id_eq?: InputMaybe<Scalars['_text']>;
...
export type Subscription_RootSec_Contract_TypeArgs = {
  distinct_on?: InputMaybe<Array<Sec_Contract_Type_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Sec_Contract_Type_Order_By>>;
...
export type Subscription_RootSec_Contract_Type_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Sec_Contract_Type_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Sec_Contract_Type_Order_By>>;
...
export type Subscription_RootSec_Contract_Type_By_PkArgs = {
  id: Scalars['Int'];
};
...
export type SearchResultFragment = { __typename?: 'sec_contract', uid: string, accession_number: string, sequence: number, company_name: string, company_cik: string, company_sic_name: string, filing_type: string, filing_date: string, description: string, attachment_type: string, contract_type_id?: number | null };
...
export type SearchSecContractsQueryVariables = Exact<{
  ...
  contractTypes?: InputMaybe<Scalars['_text']>;
  companyCiks?: InputMaybe<Scalars['_text']>;
}>;


export type SearchSecContractsQuery = { __typename?: 'query_root', sec_search_aggregate: { __typename?: 'sec_contract_aggregate', nodes?: Array<{ __typename?: 'sec_contract', uid: string }>, aggregate?: { __typename?: 'sec_contract_aggregate_fields', count: number, filing_count: number, company_count: number } | null }, sec_search?: Array<{ __typename?: 'sec_contract', uid: string, accession_number: string, sequence: number, company_name: string, company_cik: string, company_sic_name: string, filing_type: string, filing_date: string, description: string, attachment_type: string, contract_type_id?: number | null }>, companies: Array<{ __typename?: 'sec_contract', company_cik: string }>, contract_types: Array<{ __typename?: 'sec_contract', contract_type_id?: number | null }> };

export type SecContractFragment = { __typename?: 'sec_filing_attachment', uid: string, sequence: number, attachment_type: string, description?: string | null, contents: string, sec_filing: { __typename?: 'sec_filing', accession_number: string, filing_date: Date, filing_type: string, sec_company: { __typename?: 'sec_company', cik: string, name: string, sic: string, sic_name: string } } };

export type CompanyFragment = { __typename?: 'sec_contract', company_cik: string, company_name: string, company_geo: string };

export type GetSecContractCompaniesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSecContractCompaniesQuery = { __typename?: 'query_root', sec_contract: Array<{ __typename?: 'sec_contract', company_cik: string, company_name: string, company_geo: string }> };
...
export type GetSecContractQuery = { __typename?: 'query_root', sec_filing_attachment_by_pk?: { __typename?: 'sec_filing_attachment', uid: string, sequence: number, attachment_type: string, description?: string | null, contents: string, sec_filing: { __typename?: 'sec_filing', accession_number: string, filing_date: Date, filing_type: string, sec_company: { __typename?: 'sec_company', cik: string, name: string, sic: string, sic_name: string } } } | null };

export type SecContractTypeFragment = { __typename?: 'sec_contract_type', id: number, name: string, parent_id?: number | null };

export type GetContractTypesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetContractTypesQuery = { __typename?: 'query_root', sec_contract_type: Array<{ __typename?: 'sec_contract_type', id: number, name: string, parent_id?: number | null }> };

export type CurrentUserFragment = { __typename?: 'user', id: number, email: string, name: string, photo_url?: string | null, default_org: { __typename?: 'org', id: number, name: string } };
...
export type GetCurrentUserQuery = { __typename?: 'query_root', user: Array<{ __typename?: 'user', id: number, email: string, name: string, photo_url?: string | null, default_org: { __typename?: 'org', id: number, name: string } }> };
...
export type SyncUserMutation = { __typename?: 'mutation_root', insert_user_one?: { __typename?: 'user', id: number, auth0_id: string, email: string, name: string, default_org: { __typename?: 'org', id: number, name: string } } | null };
...
export const CompanyFragmentDoc = gql`
  ...
  company_geo
    ...
    `;
export const SecContractTypeFragmentDoc = gql`
    fragment SECContractType on sec_contract_type {
  id
  name
  parent_id
}
...
export const SearchSecContractsDocument = gql`
    query SearchSECContracts($search: String!, $minDate: date, $maxDate: date, $limit: Int = 20, $offset: Int = 0, $uidsOnly: Boolean = false, $contractTypes: _text, $companyCiks: _text) {
  sec_search_aggregate(
    args: {search: $search, filing_date_gt: $minDate, filing_date_lt: $maxDate, contract_type_id_eq: $contractTypes, company_cik_eq: $companyCiks}
  ) {
  ...
  companies: sec_search(
    args: {filing_date_gt: $minDate, filing_date_lt: $maxDate, contract_type_id_eq: $contractTypes}
    distinct_on: [company_cik]
  ) {
    company_cik
  }
  contract_types: sec_search(
    args: {filing_date_gt: $minDate, filing_date_lt: $maxDate, company_cik_eq: $companyCiks}
    distinct_on: [contract_type_id]
  ) {
    contract_type_id
  }
}
 ...
 * });
 */
export function useSearchSecContractsQuery(baseOptions: Apollo.QueryHookOptions<SearchSecContractsQuery, SearchSecContractsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SearchSecContractsQuery, SearchSecContractsQueryVariables>(SearchSecContractsDocument, options);
      }
export function useSearchSecContractsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchSecContractsQuery, SearchSecContractsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchSecContractsQuery, SearchSecContractsQueryVariables>(SearchSecContractsDocument, options);
        }
export type SearchSecContractsQueryHookResult = ReturnType<typeof useSearchSecContractsQuery>;
export type SearchSecContractsLazyQueryHookResult = ReturnType<typeof useSearchSecContractsLazyQuery>;
export type SearchSecContractsQueryResult = Apollo.QueryResult<SearchSecContractsQuery, SearchSecContractsQueryVariables>;
 ...
 * });
 */
export function useGetSecContractCompaniesQuery(baseOptions?: Apollo.QueryHookOptions<GetSecContractCompaniesQuery, GetSecContractCompaniesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSecContractCompaniesQuery, GetSecContractCompaniesQueryVariables>(GetSecContractCompaniesDocument, options);
      }
export function useGetSecContractCompaniesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSecContractCompaniesQuery, GetSecContractCompaniesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSecContractCompaniesQuery, GetSecContractCompaniesQueryVariables>(GetSecContractCompaniesDocument, options);
        }
export type GetSecContractCompaniesQueryHookResult = ReturnType<typeof useGetSecContractCompaniesQuery>;
export type GetSecContractCompaniesLazyQueryHookResult = ReturnType<typeof useGetSecContractCompaniesLazyQuery>;
export type GetSecContractCompaniesQueryResult = Apollo.QueryResult<GetSecContractCompaniesQuery, GetSecContractCompaniesQueryVariables>;
 ...
 * });
 */
export function useGetSecContractQuery(baseOptions: Apollo.QueryHookOptions<GetSecContractQuery, GetSecContractQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSecContractQuery, GetSecContractQueryVariables>(GetSecContractDocument, options);
      }
export function useGetSecContractLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSecContractQuery, GetSecContractQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSecContractQuery, GetSecContractQueryVariables>(GetSecContractDocument, options);
        }
export type GetSecContractQueryHookResult = ReturnType<typeof useGetSecContractQuery>;
export type GetSecContractLazyQueryHookResult = ReturnType<typeof useGetSecContractLazyQuery>;
export type GetSecContractQueryResult = Apollo.QueryResult<GetSecContractQuery, GetSecContractQueryVariables>;
 ...
 * });
 */
export function useGetContractTypesQuery(baseOptions?: Apollo.QueryHookOptions<GetContractTypesQuery, GetContractTypesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetContractTypesQuery, GetContractTypesQueryVariables>(GetContractTypesDocument, options);
      }
export function useGetContractTypesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetContractTypesQuery, GetContractTypesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetContractTypesQuery, GetContractTypesQueryVariables>(GetContractTypesDocument, options);
        }
export type GetContractTypesQueryHookResult = ReturnType<typeof useGetContractTypesQuery>;
export type GetContractTypesLazyQueryHookResult = ReturnType<typeof useGetContractTypesLazyQuery>;
export type GetContractTypesQueryResult = Apollo.QueryResult<GetContractTypesQuery, GetContractTypesQueryVariables>;
...
export const SyncUserDocument = gql`
    mutation SyncUser($auth0_id: String!, $email: String!, $name: String!, $nickname: String, $given_name: String, $family_name: String, $photo_url: String, $org: org_insert_input!) {
  insert_user_one(
    object: {auth0_id: $auth0_id, name: $name, nickname: $nickname, given_name: $given_name, family_name: $family_name, email: $email, photo_url: $photo_url, default_org: {data: $org, on_conflict: {constraint: org_auth0_id_key, update_columns: [auth0_connection_name]}}}
    on_conflict: {constraint: user_auth0_id_key, update_columns: [email, name, nickname, given_name, family_name, photo_url, default_org_id]}
  ) {
    id
    auth0_id
    email
